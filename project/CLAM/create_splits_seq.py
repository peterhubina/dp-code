...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes = 2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tcga_brca_recurrence.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
    ...
    args.n_classes = 2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/nou_ctc_ep.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
    ...
    args.n_classes = 2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/nou_ctc_emt.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
    ...
    args.n_classes = 2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/nou_ctc_any.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,

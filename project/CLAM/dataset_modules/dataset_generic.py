...
def save_splits(split_datasets, column_keys, filename, boolean_style=False):
	splits = [split_datasets[i].slide_data['slide_id'] if split_datasets[i] is not None else pd.Series(name=column_keys[i], dtype=object) for i in range(len(split_datasets))]

"""
PAM50 Inference on HSI-BC-Recurrence Dataset
=============================================
Runs 10-fold CLAM-MB inference on HSI-BC slide features using checkpoints
...
Note: Ground-truth labels are IHC-surrogate subtypes mapped to PAM50
equivalents (see prepare_manifest.py for the mapping).
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="PAM50 inference on HSI-BC features")
    parser.add_argument("--feature_dir", type=str,
                        default=".scratch/hsi_bc_recurrence/features/h5_files")
    ...
    parser.add_argument("--output_dir", type=str,
                        default=".scratch/hsi_bc_recurrence/results/predictions")
...
def main():
    ...
    # Map string labels to int for evaluation
